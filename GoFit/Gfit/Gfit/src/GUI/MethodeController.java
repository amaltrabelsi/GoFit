...
public class MethodeController implements Initializable {
    ...
    private Button parq;
    @FXML
    private Button recuperationparsms;
    ...
    @FXML
    private void recuperationparsms(ActionEvent event) {
         try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../GUI/ParSMS.fxml"));
            Parent root = loader.load();
            parq.getScene().setRoot(root);
           } catch (IOException ex) {
            Logger.getLogger(ConnexionController.class.getName()).log(Level.SEVERE, null, ex);
