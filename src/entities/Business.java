...
public class Business {
    ...
    public Business(String Nom_Business, String Nom_Gerant, String Prenom_Gerant, String Region, String Adresse, Date Date_Fondation, String Description, String Tel_Portable, String Tel_Fix) {
    ...
    public String toString() {
        return "Business{" + "Business_Id=" + Business_Id + ", Nom_Business=" + Nom_Business + ", Nom_Gerant=" + Nom_Gerant + ", Prenom_Gerant=" + Prenom_Gerant + ", Region=" + Region + ", Adresse=" + Adresse + ", Date_Fondation=" + Date_Fondation + ", Description=" + Description + ", Tel_Portable=" + Tel_Portable + ", Tel_Fix=" + Tel_Fix + '}';
    }
