...
public class Business {
    ...
    public String toString() {
        return "Business{" + "Business_Id=" + Business_Id + ", Nom_Business=" + Nom_Business + ", Nom_Gerant=" + Nom_Gerant + ", Prenom_Gerant=" + Prenom_Gerant + ", Region=" + Region + ", Adresse=" + Adresse + ", Date_Fondation=" + Date_Fondation + ", Description=" + Description + ", Tel_Portable=" + Tel_Portable + ", Tel_Fix=" + Tel_Fix + ", Note=" + Note + ", Compte_Id=" + Compte_Id + ", FK_Produit_Id=" + FK_Produit_Id + '}';
    }
