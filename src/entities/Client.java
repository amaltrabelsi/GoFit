...
public class Client {
 ...
 public Client() {}
    public Client(String Nom_Client, String Prenom_Client, String Region, String Adresse, Date Date_Naiss, String Tel_Portable, int Fk_Historique_Id, int Fk_Commentaire_Id, int Fk_Avis_Id, int Fk_AvisCovid_Id, int Fk_Panier_Id, int Compte_Id) {
    ...
    public String toString() {
        return "Client{" + "Client_Id=" + Client_Id + ", Nom_Client=" + Nom_Client + ", Prenom_Client=" + Prenom_Client + ", Region=" + Region + ", Adresse=" + Adresse + ", Date_Naiss=" + Date_Naiss + ", Tel_Portable=" + Tel_Portable + ", Fk_Historique_Id=" + Fk_Historique_Id + ", Fk_Commentaire_Id=" + Fk_Commentaire_Id + ", Fk_Avis_Id=" + Fk_Avis_Id + ", Fk_AvisCovid_Id=" + Fk_AvisCovid_Id + ", Fk_Panier_Id=" + Fk_Panier_Id + ", Compte_Id=" + Compte_Id + '}';
    }
